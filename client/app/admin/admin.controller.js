...
(function () {
    var AdminController = (function () {
        function AdminController($scope, Pages, $http, Upload, $uibModal, $log) {
                        ...
                        Upload.upload({
                            ...
                            if (page === 'home') {
                                if (position === 'left') {
                                    ...
                                    if ($scope.model.pages.home.slider.indexOf(xmlDoc.getElementsByTagName('Location')[0].childNodes[0].nodeValue) !== 0) {
    ...
    var ModalInstanceCtrl = (function () {
        function ModalInstanceCtrl($scope, $uibModalInstance, bird, Upload, $http) {
            $scope.nbird = bird;
            $scope.countryList =
                    ...
                    $http.post('/api/signing', query)
                        ...
                        Upload.upload({
                            ...
                            if (page === 'modal') {
                                ...
                                if ($scope.nbird.photos.indexOf(xmlDoc.getElementsByTagName('Location')[0].childNodes[0].nodeValue) !== 0) {
